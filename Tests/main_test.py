...
class EcommerceTest(unittest.TestCase):
    ...
    def test_flipkart_page(cls):
        try:
            ...
            cls.product, cls.flipkart_price, cls.flipkart_rating, cls.flipkart_people_rate, cls.flipkart_review,cls.avg_five_star,cls.avg_one_star = flipkart_obj.flipkart_compare(cls.flipkart_link)
